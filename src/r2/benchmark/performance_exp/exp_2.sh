...
# ./hpnmalloc2.out $BASE $BLKSIZE $THNUM


# i="1"
# while [ $i -lt 9 ]
# do 
#     python3 ../static_analy.py 9 ./exp_data/hpn_res$(($i)).txt ./exp_data/hpn1_res$(($i)).txt ./exp_data/wa_res$(($i)).txt ./exp_data/nvm_res$(($i)).txt $(($i))
#     i=$(($i+1))
# done
