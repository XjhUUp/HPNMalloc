...
def func1(file_path,pic_name):
    ...
    # 显示图形
    #plt.show()  
    pic_path='./wear_exp/exp_pic/'+pic_name
...
def func3(file_path1,file_path2,file_path3):
   # 创建数据
    df1 = pd.read_table(file_path1, header=None)
    df2 = pd.read_table(file_path2, header=None)
    df3 = pd.read_table(file_path3, header=None)
    for i in range(len(df1[0])):
        categories = ['HPNMalloc', 'CPMA', 'Wamalloc']
        ...
        # 显示图形
        #plt.show()
        pic_name='./hm_alloc_exp/exp_pic/hpn'+str(i)+'.png'
        plt.savefig(pic_name,bbox_inches='tight',dpi=300)
        plt.cla()

def func4(file_path1,file_path2,file_path3,file_path4,pic_name):
    df1 = pd.read_table(file_path1, header=None)
    df2 = pd.read_table(file_path2, header=None)
    df3 = pd.read_table(file_path3, header=None)
    ...
    y=[]
    for i in range(len(df1[0])):
        y.append(float(df1[0][i].split(' ')[0]))
    ...
    y=[]
    for i in range(len(df2[0])):
        y.append(float(df2[0][i].split(' ')[0]))
    # 绘制第二条曲线
    ax.plot(x, y, 'o-',label='HPN1')
    y=[]
    for i in range(len(df3[0])):
        y.append(float(df3[0][i].split(' ')[0]))
    ax.plot(x, y, 'o-',label='WA')
    y=[]
    for i in range(len(df4[0])):
        y.append(float(df4[0][i].split(' ')[0]))
    ...
    # 添加图例
    legend = ax.legend(loc='upper right',bbox_to_anchor=(1, 0.9))
...
def func5(file_path1,file_path2,file_path3,file_path4,pic_name):
    df1 = pd.read_table(file_path1, header=None)
    df2 = pd.read_table(file_path2, header=None)
    df3 = pd.read_table(file_path3, header=None)
    df4 = pd.read_table(file_path4, header=None)
    ...
    y=[]
    for i in range(len(df1[0])):
        y.append(float(df1[0][i].split(' ')[1]))
    ...
    y=[]
    for i in range(len(df2[0])):
        y.append(float(df2[0][i].split(' ')[1]))
    # 绘制第二条曲线
    ax.plot(x, y, 'o-',label='HPN1')
    y=[]
    for i in range(len(df3[0])):
        y.append(float(df3[0][i].split(' ')[1]))
    ax.plot(x, y, 'o-',label='WA')
    y=[]
    for i in range(len(df4[0])):
        y.append(float(df4[0][i].split(' ')[1]))
    ax.plot(x, y, 'o-',label='NVM')
    plt.xticks(x)
    ...
    # 设置标题、x轴和y轴的标签
    plt.xlabel('Number of malloc(ten thousand)')
    plt.ylabel('Average wear frequency')
...
def func8(file_path1,file_path2,file_path3,file_path4,pic_name):
    df1 = pd.read_table(file_path1, header=None)
    df2 = pd.read_table(file_path2, header=None)
    df3 = pd.read_table(file_path3, header=None)
    df4 = pd.read_table(file_path4, header=None)
...
def func9(file_path1,file_path2,file_path3,file_path4,pic_name):
    df1 = pd.read_table(file_path1, header=None)
    df2 = pd.read_table(file_path2, header=None)
    df3 = pd.read_table(file_path3, header=None)
    df4 = pd.read_table(file_path4, header=None)
...
if __name__=="__main__":
    ...
    if eval_num == 3:
        ...
        func3(file_path1,file_path2,file_path3)
    if eval_num == 4:
        file_path1=str(sys.argv[2])
        file_path2=str(sys.argv[3])
        file_path3=str(sys.argv[4])
        file_path4=str(sys.argv[5])
        pic_name=str(sys.argv[6])
        func4(file_path1,file_path2,file_path3,file_path4,pic_name)
    if eval_num == 5:
        file_path1=str(sys.argv[2])
        file_path2=str(sys.argv[3])
        file_path3=str(sys.argv[4])
        file_path4=str(sys.argv[5])
        pic_name=str(sys.argv[6])
        func5(file_path1,file_path2,file_path3,file_path4,pic_name)
    if eval_num == 6:
        file_path1=str(sys.argv[2])
        file_path2=str(sys.argv[3])
        file_path3=str(sys.argv[4])
    ...
    if eval_num == 8:
        ...
        file_path4=str(sys.argv[5])
        pic_name=str(sys.argv[6])
        func8(file_path1,file_path2,file_path3,file_path4,pic_name)
    if eval_num == 9:
        file_path1=str(sys.argv[2])
        file_path2=str(sys.argv[3])
        file_path3=str(sys.argv[4])
        file_path4=str(sys.argv[5])
        pic_name=str(sys.argv[6])
        func9(file_path1,file_path2,file_path3,file_path4,pic_name)
